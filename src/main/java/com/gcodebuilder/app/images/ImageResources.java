...
public class ImageResources {
    ...
    public static final String ICON_RESOURCE_PREFIX = "gcb_icon";
    public static final String ICON_RESOURCE_SUFFIX = ".png";
    public static final int[] ICON_RESOURCE_SIZES = {16, 32, 64, 128, 256, 512, 1024};

    public static List<Image> loadIcons(boolean backgroundLoading) {
        return Arrays.stream(ICON_RESOURCE_SIZES)
                .mapToObj(size -> String.format("%s_%d%s", ICON_RESOURCE_PREFIX, size, ICON_RESOURCE_SUFFIX))
